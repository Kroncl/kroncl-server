...
type DealTransactionsSummary struct {
	TotalAmount   float64            `json:"total_amount"`   // итоговая сумма (доходы - расходы)
	IncomeAmount  float64            `json:"income_amount"`  // сумма доходных транзакций
	ExpenseAmount float64            `json:"expense_amount"` // сумма расходных транзакций
